...
STAGE2_BLOCK_QUESTION_COUNTS = {
    KnowledgeBlock.CLIENT_STAKEHOLDER_RELATIONSHIPS: 6,
    KnowledgeBlock.INTERNAL_PROCESSES_WORKFLOWS: 7,
    KnowledgeBlock.TECHNICAL_SYSTEMS_TOOLS: 6,
    KnowledgeBlock.DECISION_MAKING_LOGIC: 6,
    KnowledgeBlock.TEAM_DYNAMICS_MANAGEMENT: 5,
    KnowledgeBlock.SUPPLIER_VENDOR_RELATIONSHIPS: 5,
    KnowledgeBlock.REGULATORY_COMPLIANCE: 5,
    KnowledgeBlock.UNDOCUMENTED_WORKAROUNDS: 5,
    KnowledgeBlock.STRATEGIC_CONTEXT: 5,
}
